...
export function render() {
  ...
  HEADER.innerHTML = `
    <div class="top-row">
      <a href="/" class="centered-link" onclick="stopInterval()">${getSvgIcon('lzr', 'xl', 'var(--color--primary)')}</a>
      <span>${currentPark.name}</span>
      <a href="/settings" class="lzr-button lzr-outlined lzr-square lzr-primary" onclick="stopInterval()">${getSvgIcon('gear', 'm', 'var(--color--primary)')}</a>
    </div>
